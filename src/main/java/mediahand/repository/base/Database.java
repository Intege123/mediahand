            ...
            try {
                statement.execute(
                        "CREATE TABLE mediaTable(id INT IDENTITY PRIMARY KEY, Title VARCHAR(255) UNIQUE, Episodes INT NOT NULL, "
                                ...
                                "WatchedDate DATE, WatchNumber INT, Volume INT, dirtable_fk INT, Audiotrack VARCHAR(255), Subtitletrack VARCHAR(255), FOREIGN KEY (dirtable_fk) REFERENCES DIRTABLE(id))");
